...
\begin{tikzpicture}[thick]
  ...
  \node[color=blue, rectangle, draw, text badly ragged, rounded corners, minimum height=20,
        text width=110, below of=QcMatDef, node distance=159] (RealMatDef) %
       {\verb|typedef struct {| %
  ...
  \node[color=black, rectangle, draw, text badly ragged, rounded corners, minimum height=20, % 
       ...
       {\verb|function QcMatGetExternalMat(A, ..., |\color{green}\verb|A_ext|\color{black}\verb|) result(ierr)| %
        \linebreak\verb|  integer :: ierr| %
        \linebreak\verb|  type(QcMat), intent(in) :: A| %
        \linebreak\verb|  ... ...| %
        \linebreak\color{green}\verb|  type(LANG_F_MATRIX), pointer, intent(inout) :: A_ext| %
        \linebreak\color{blue}\verb|  type(C_PTR) c_A| %
        \linebreak\color{red}\verb|  ierr = f03_api_QcMatGetAdapterMat(|\color{black}\verb|A%c_mat, |\color{red}\verb|..., |\color{blue}\verb|c_A|\color{red}\verb|)| %
        \linebreak\color{black}\verb|  call c_f_pointer(|\color{blue}\verb|c_A, |\color{green}\verb|A_ext|\color{black}\verb|)| %
  ...
  \node[color=red, rectangle, draw, text badly ragged, rounded corners, minimum height=20, % 
       ...
       {\verb|QErrorCode f03_api_QcMatGetAdapterMat(|\color{black}\verb|QVoid **A,| %
        ...
        \linebreak\verb|  ierr = QcMatGetAdapterMat(c_A, ..., |\color{blue}\verb|&A_adapter|\color{red}\verb|);| %
        \linebreak\color{blue}\verb|  ierr = AdapterMatGetExternalMat(A_adapter, f_A);| %
  ...
  \node[color=blue, rectangle, draw, text badly ragged, rounded corners, minimum height=20, % 
        text width=315, below of=NoteAdapterC, node distance=32] (AdapterC) %
       {\verb|QErrorCode AdapterMatGetExternalMat(RealMat *A, QVoid **f_A)| %
        \linebreak\verb|  *f_A = (QVoid *)A->f03_mat;| %
