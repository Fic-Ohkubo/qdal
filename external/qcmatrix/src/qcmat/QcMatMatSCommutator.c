/* QcMatrix: an abstract matrix library
   ...
   This file implements the function QcMatMatSCommutator().
...
/*@% \brief calculates the commutator C = [A,B]_{S} = A*B*S-S*B*A
     \author Bin Gao
     \date 2012-04-04
...
*/
QErrorCode QcMatMatSCommutator(QcMat *A, QcMat *B, QcMat *S, QcMat *C)
{
