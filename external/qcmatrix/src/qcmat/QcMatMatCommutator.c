/* QcMatrix: an abstract matrix library
   ...
   This file implements the function QcMatMatCommutator().
...
/*@% \brief calculates the commutator C = [A,B] = A*B-B*A
     \author Bin Gao
     \date 2012-04-04
...
*/
QErrorCode QcMatMatCommutator(QcMat *A, QcMat *B, QcMat *C)
{
